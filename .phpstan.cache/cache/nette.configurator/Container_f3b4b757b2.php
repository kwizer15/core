...
class Container_f3b4b757b2 extends _PHPStan_ce257d9ac\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_f3b4b757b2 $container)
			{
	...
	public function createServiceContainer(): Container_f3b4b757b2
	{
		return $this;
	}
