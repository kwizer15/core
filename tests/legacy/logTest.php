...
class logTest extends TestCase
{
    public function getEngins()
    {
        return [
            ...
            ['foo', 'Monolog\Handler\StreamHandler'],
        ];
    }
    ...
    {
        return [
            [Monolog\Logger::DEBUG, E_ERROR | E_WARNING | E_PARSE | E_NOTICE],
            [Monolog\Logger::INFO, E_ERROR | E_WARNING | E_PARSE | E_NOTICE],
            [Monolog\Logger::NOTICE, E_ERROR | E_WARNING | E_PARSE | E_NOTICE],
            [Monolog\Logger::WARNING, E_ERROR | E_WARNING | E_PARSE],
            [Monolog\Logger::ERROR, E_ERROR | E_PARSE],
            [Monolog\Logger::CRITICAL, E_ERROR | E_PARSE],
            [Monolog\Logger::ALERT, E_ERROR | E_PARSE],
            [Monolog\Logger::EMERGENCY, E_ERROR | E_PARSE],
        ];
    }
